...
struct spi_device ad9834_spi_device_conf = {
...
{				
	...
	spi_select_device(CONF_AD9834_SPI_PORT, &ad9834_spi_device_conf);
	...
	spi_deselect_device(CONF_AD9834_SPI_PORT, &ad9834_spi_device_conf);
}
...
{		
	...
	spi_master_setup_device(CONF_AD9834_SPI_PORT, &ad9834_spi_device_conf, spi_flags, CONF_AD9834_SPI_PORT_CLOCK_SPEED, spi_select_id);
