...
#define CONF_SST25_MOSI_PIN		IOPORT_CREATE_PIN(PORTC, 5)	// ATMEGA OUTPUT / SI 5 arancio/giallo
#define CONF_SST25_MISO_PIN		IOPORT_CREATE_PIN(PORTC, 6) // ATMEGA INPUT / SO 2 rosso/blu
