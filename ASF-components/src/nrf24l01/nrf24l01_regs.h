...
// Commands
#define NRF24L01_R_REGISTER		0x00		// Read command and status registers
#define NRF24L01_W_REGISTER		0x20		// Write command and status registers
#define NRF24L01_R_RX_PAYLOAD	0x61		// Read RX-payload
#define NRF24L01_W_TX_PAYLOAD	0xA0		// Write TX-payload
...
#define NRF24L01_REGISTER_MASK	0x1F		// Five bit mask (11111) for selecting register
...
#define NRF24L01_TX_REUSE_BM	(1 << 6)
#define NRF24L01_FIFO_STATUS_TX_FULL_BM		(1 << 5)
#define NRF24L01_TX_EMPTY_BM	(1 << 4)	// Default 1
#define NRF24L01_RX_FULL_BM		(1 << 1)			
#define NRF24L01_RX_EMPTY_BM	(1 << 0)	// Default 1
